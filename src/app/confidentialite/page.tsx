  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-4 text-neutral-900/70">
        ...
        monpretassure.fr, pourquoi, et comment exercer vos droits.
      </p>
      ...
      <ul className="mt-3 space-y-2 text-sm text-neutral-900/70">
        {[
          ...
          "Adresse e-mail",
          "Numéro de téléphone",
          "Éléments de votre projet (capital emprunté, banque prêteuse, situation, message)",
        ].map((item) => (
      ...
      <p className="mt-3 text-sm text-neutral-900/70">
        Le site ne collecte aucune donnée de santé ni aucun document médical :
        ces informations, nécessaires à l&apos;étude d&apos;un contrat
        d&apos;assurance emprunteur, ne sont échangées qu&apos;ultérieurement,
        par téléphone ou en agence, via les canaux sécurisés des compagnies
      ...
      <p className="mt-3 text-sm text-neutral-900/70">
        ...
        de contact ou d&apos;étude d&apos;assurance emprunteur, sur la base de
        votre consentement exprimé en soumettant le formulaire.
      </p>
